...
const HeroTwo = () => {
  return (
    <div className="ImageTwo flex items-center justify-center h-full px-2">
      <div className="flex flex-col h-[400px] items-center justify-center mx-auto bg-black/80 border-1 border-gray-700 p-2 rounded-3xl">
        <h1 className="text-8xl sm:text-[8rem] font-racing text-center text-red-200  font-bold">
          Ofertas
        </h1>
