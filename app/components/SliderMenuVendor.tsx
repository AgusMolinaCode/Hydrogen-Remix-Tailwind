...
function ParallaxText({
   ...
   */
  return (
    <div className="parallax bg-rose-300">
      <motion.div className="scroller w-full" style={{x}}>
        {[...Array(30)].map((_, i) => (
          <p
            key={i}
            className="text-base sm:text-lg tracking-normal flex items-center  text-gray-900 justify-center m-1 font-Righteous"
          >
            <span className="font-bold text-base sm:text-lg font-Righteous tracking-normal text-gray-600">
              {prefixText}
            </span>
            {children}{' '}
          </p>
